    ...
    public partial class CZBooksContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //String de conexão SENAI (2 - BOLINHA AMARELA )
                optionsBuilder.UseSqlServer("Data Source=LAB08DESK2701\\SQLEXPRESS01; initial catalog=CZBooks; integrated security=true");
